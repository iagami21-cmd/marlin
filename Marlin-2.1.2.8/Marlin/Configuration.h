...
//#define SPI_FLASH
//#define MKS_WIFI_MODULE // Interface WiFi MKS/LVGL original (não usada pela UI TS35 personalizada)
#define TS35_WIFI_MODULE // Suporte ao módulo Robin-WIFI no menu Touch TS35 (Monster8 V2)
